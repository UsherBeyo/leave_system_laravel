...
class LeavePolicyService
{
    public function normalizeLeaveTypeKey(string $name): string
    {
        ...
        $aliases = [
            ...
            'spl' => 'special privilege leave', 'special privilege' => 'special privilege leave',
    ...
    public function uiPreset(string $typeName, array $usedByYear = []): array
    {
        ...
        return match ($key) {
            ...
            'special privilege leave' => array_merge($base,['bucket'=>'spl','bucket_label'=>'SPL Balance','deduct_balance'=>true,'max_days'=>3,'max_days_per_year'=>3,'min_days_notice'=>5,'subtype_label'=>'Special Privilege Leave Details','subtypes'=>['within_ph'=>'Within the Philippines','abroad'=>'Abroad'],'show_location_text'=>true,'location_label'=>'Location / Destination','documents'=>['special_privilege_supporting_document'=>'Special Privilege Leave supporting document'],'required_doc_count'=>1,'rules_text'=>['Special Privilege Leave must be filed five (5) days before the start date.','Only up to three (3) days may be consumed in one year.','Supporting document attachment is required.','This leave deducts from the SPL Balance.']]),
            'wellness leave' => array_merge($base,['bucket'=>'wellness','bucket_label'=>'Wellness Balance','deduct_balance'=>true,'max_days'=>3,'max_days_per_year'=>5,'rules_text'=>['Wellness Leave can be applied for a maximum of three (3) days per application.','Wellness Leave resets to five (5) days every year.','This leave deducts from the Wellness Balance.']]),
